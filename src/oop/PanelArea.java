...
public class PanelArea extends JPanel {
	...
	private ArrayList<UMLObject> umlObjectList;
	private ArrayList<ConnectionLine> umlLine;
	private ArrayList<Composite> groupList;
	...
	public PanelArea() {
		...
		umlObjectList = new ArrayList<UMLObject>();
		umlLine = new ArrayList<ConnectionLine>();
		groupList = new ArrayList<Composite>();
	...
	public void addListener() {
		this.addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent e) {
				int x = e.getX();
				int y = e.getY();
				mod.mousePressed(x, y);
			}

			public void mouseReleased(MouseEvent e) {
				int x = e.getX();
				int y = e.getY();
				mod.mouseReleased(x, y);
			}
		});
	...
	public GridBagConstraints getGridBagConstraints() {return gbc_panel;}
	
	public void addUMLObject(UMLObject object) {umlObjectList.add(object);}
	
	public void setUMLObjectID() {
		int lastIndex = umlObjectList.size()-1;
		umlObjectList.get(lastIndex).setOriginObjectID(lastIndex);
	}
	
	public void addConnectionLine(ConnectionLine line) {umlLine.add(line);}
	
	public void setIsSelectOnGroup(Boolean b) {isSelectOnGroup = b;}
	
	public Boolean isSelectOnGroup() {return isSelectOnGroup;}
	public void setIsSelectOnObject(Boolean b) {isSelectOnObject = false;}
	...
	public void ungroup() {
		for(int i = groupList.size()-1; i >= 0; i--) {
			if(groupList.get(i).isSelected()) {
				ArrayList<Shape> temp = groupList.get(i).getGroupObjectList();
